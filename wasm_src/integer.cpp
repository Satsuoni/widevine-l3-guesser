...
template class AllocatorWithCleanup<unsigned char, false>;
...
/*template <> Integer AbstractRing<Integer>::Exponentiate(const Element &base, const Integer &exponent) const
{
	Element result;
