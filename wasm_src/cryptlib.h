...
public:
	...
	//@{
		...
		virtual BufferedTransformation *AttachedTransformation() { return NULLPTR;}
...
public:
	...
	virtual void Precompute(unsigned int precomputationStorage) {
		CRYPTOPP_UNUSED(precomputationStorage);
	...
	virtual void LoadPrecomputation(BufferedTransformation &storedPrecomputation)
		{CRYPTOPP_UNUSED(storedPrecomputation);  throw NotImplemented("CryptoMaterial: this object does not support precomputation");}
